...
if [%1] == [] (
    echo Usage:   %0  Vue_files_folders  [Is_Check_CallTimes](default: 0)  [Need_Show_Detail](default: 0)
    echo Example: %0  private\DataUsageTelemetry\DataZenPortal\Frontend
    echo Example: %0  private\DataUsageTelemetry\DataZenPortal\Frontend 1
    echo Example: %0  private\DataUsageTelemetry\DataZenPortal\Frontend 0 1
    echo Is_Check_CallTimes = 0 : Check unused methods.
    echo Is_Check_CallTimes = 1 : Check methods called more than 1 times.
    exit /b -1
)

set Vue_files_folders=%1
set Is_Check_CallTimes=%2
set Need_Show_Detail=%3

if [%Is_Check_CallTimes%] == [1] (
